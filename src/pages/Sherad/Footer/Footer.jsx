const Footer = () => {
    return (
        <footer>
            <div className="footer lilita p-10 bg-neutral text-neutral-content">
                <div>
                    <h3 className="text-[#FCCB05] font-extrabold text-2xl">CONTACT US</h3>
                    <p>123 ABS Street, Uni 21, Bangladesh</p>
                    <p>ACME Industries Ltd.<br />Providing reliable tech since 1992</p>
                </div>
                <div>
                    <span className="footer-title">
                        <div className="bg-neutral text-neutral-content font-extrabold lilita">
                            <h4 className="text-white  text-2xl">Follow <span>US</span></h4>
